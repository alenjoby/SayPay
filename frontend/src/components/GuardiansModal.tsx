      ...
      <div className="w-full max-w-xl bg-white rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-200">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h2 id="guardians-title" className="text-xl font-black text-slate-900 font-display">
                Guardians & Recovery
              </h2>
            </div>
          </div>
        ...
        <div className="flex gap-2 p-1 mt-4 bg-slate-100 rounded-xl text-xs font-bold">
          <button
            ...
            className={`flex-1 py-2 rounded-lg transition ${
              activeTab === 'status' ? 'bg-white text-slate-950 shadow-sm font-black' : 'text-slate-600 hover:text-slate-900'
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-2 rounded-lg transition ${
              activeTab === 'recovery' ? 'bg-white text-slate-950 shadow-sm font-black' : 'text-slate-600 hover:text-slate-900'
            }`}
          >
            Lost-Phone Recovery
          </button>
          <button
            ...
            className={`flex-1 py-2 rounded-lg transition ${
              activeTab === 'inheritance' ? 'bg-white text-slate-950 shadow-sm font-black' : 'text-slate-600 hover:text-slate-900'
            }`}
          >
            Inheritance Switch
          </button>
          ...
          <div className="mt-5 space-y-3">
            ...
            <div className="space-y-2 pt-1">
              {guardians.map((g, idx) => (
                <div
                  key={g.id}
                  className="flex items-center justify-between p-3.5 rounded-xl border border-slate-200 bg-white hover:border-[#00E575] transition"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-slate-100 text-slate-900 font-bold text-xs flex items-center justify-center font-mono">
                      {idx + 1}
                    </div>
                    <div>
                  ...
                  <span className="text-[11px] font-bold px-2 py-0.5 rounded-full bg-[#00E575]/15 text-emerald-800">
                    Active
                  </span>
                </div>
              ))}
        ...
        {activeTab === 'recovery' && (
          <div className="mt-5 space-y-4">
            ...
            {recoveryState === 'idle' && (
              <div className="p-4 rounded-2xl border border-dashed border-slate-200 text-center space-y-3 bg-slate-50">
                <Clock className="w-8 h-8 text-slate-500 mx-auto" />
                <div className="text-sm font-bold text-slate-900 font-display">Test Recovery Flow Simulation</div>
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl btn-lime text-xs font-black transition shadow-sm"
                >
            ...
            {recoveryState === 'vetoed' && (
              <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-300 text-center space-y-2">
                ...
                <div className="text-sm font-bold text-slate-900">Recovery Successfully Vetoed</div>
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg btn-lime text-xs font-black"
                >
                  Reset Demo
                </button>
              </div>
          ...
          <div className="mt-5 space-y-4">
            ...
            <div className="p-4 rounded-xl border border-slate-200 space-y-2">
              ...
              <div className="flex justify-between text-xs">
                ...
                <span className="font-bold text-slate-900">Amma (0x892a...12bc)</span>
              </div>
              <div className="flex justify-between text-xs">
                <span className="text-slate-500 font-medium">Heartbeat Check:</span>
                <span className="font-bold text-emerald-600">Active (Refreshed today)</span>
              </div>
            </div>
          </div>
        )}
