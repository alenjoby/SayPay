      ...
      <div className="w-full max-w-lg bg-white rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-200">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-100 mb-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h2 id="send-modal-title" className="text-xl font-black text-slate-900 font-display">
                Send Crypto
              </h2>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-4 pr-10 py-3 rounded-2xl border border-slate-200 bg-slate-50 text-sm font-bold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#00E575]"
                />
                {selectedContact && (
                  <span className="absolute right-3 top-1/2 -translate-y-1/2 px-2 py-0.5 rounded-full bg-[#00E575]/15 text-emerald-800 text-[10px] font-extrabold flex items-center gap-1">
              ...
              <div className="flex items-center gap-1.5 mt-2 overflow-x-auto pb-1">
                <span className="text-[11px] text-slate-500 font-semibold shrink-0">Quick Select:</span>
                {contacts.map((c) => (
                  <button
                    key={c.id}
                    ...
                    className={`px-2.5 py-1 rounded-full text-xs font-bold transition shrink-0 flex items-center gap-1 ${
                      selectedContact?.id === c.id
                        ? 'bg-[#00E575] text-slate-950 shadow-sm'
            ...
            <div>
              <div className="flex items-center justify-between text-xs mb-1.5">
                <span className="font-bold text-slate-600 uppercase tracking-wider">Amount (ETH):</span>
                <span className="text-slate-500 font-medium">
                  Available: <strong className="text-slate-900">{availableBalanceETH.toFixed(4)} ETH</strong>
                </span>
              </div>
              <div className="relative">
                <input
                  ...
                  className="w-full text-2xl font-black text-slate-900 px-4 py-3 rounded-2xl border border-slate-200 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-[#00E575] font-mono"
                />
            ...
            <div className="p-3 bg-emerald-500/10 rounded-2xl border border-emerald-500/20 text-xs text-emerald-950 flex items-center justify-between">
              <span className="flex items-center gap-1.5 font-semibold">
                <ShieldCheck className="w-4 h-4 text-emerald-600" />
                Sponsored Gas (ERC-4337 Paymaster)
              </span>
              <span className="font-extrabold text-emerald-700">Free / $0.00</span>
            </div>
            ...
            <div className="pt-2 flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 rounded-xl btn-lime text-xs font-black transition flex items-center justify-center gap-2 shadow-md disabled:opacity-40"
              >
        ...
        {authStage === 'passkey_prompt' && (
          <div className="space-y-4 text-center py-2 animate-fade-in">
            <div className="w-16 h-16 rounded-full bg-[#00E575]/15 text-emerald-600 mx-auto flex items-center justify-center shadow-inner">
            ...
            <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-200 text-left text-xs space-y-1.5 font-mono">
              <div className="flex justify-between">
                ...
                <span className="text-slate-900 font-bold">{resolvedName}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-500">Address:</span>
                <span className="text-slate-900 truncate max-w-[200px]">{resolvedAddress}</span>
              </div>
              <div className="flex justify-between">
            ...
            <div className="pt-2 space-y-2">
              <button
                ...
                className="w-full py-3.5 rounded-2xl btn-lime text-sm font-black transition flex items-center justify-center gap-2 shadow-lg"
              >
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-transparent hover:bg-slate-100 text-slate-600 text-xs font-bold transition"
              >
                Go Back
              </button>
            </div>
        ...
        {authStage === 'broadcasting' && (
          <div className="py-8 text-center space-y-3">
            <div className="w-14 h-14 rounded-full bg-[#00E575]/15 border-2 border-[#00E575] flex items-center justify-center mx-auto animate-spin">
